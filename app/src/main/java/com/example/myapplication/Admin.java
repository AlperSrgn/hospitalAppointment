    ...
    binding.randevuSilBtn.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(!tcNo.isEmpty()){
                ...
                binding.dbAlan.setText("");
                binding.dbHastane.setText("");
                binding.dbTarih.setText("");
                binding.dbSaat.setText("");
            }
            else{
                Toast.makeText(Admin.this, "Tc Kimlik Numarası Girin",Toast.LENGTH_SHORT).show();
            }
        }
    });
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                ...
                if(task.isSuccessful()){
                    if(task.getResult().exists()){
                        ...
                        String sehir = String.valueOf(dataSnapshot.child("alan").getValue());
